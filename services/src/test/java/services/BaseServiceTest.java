...
/**
 * Tests BaseService functionality through CategoryService (generic type is preserved only in subclasses).
 */
...
public class BaseServiceTest {
    ...
    public void testSaveOrUpdate_WithException() {
        // Arrange
        doThrow(new HibernateException("Test exception")).when(categoryDao).saveOrUpdate(testCategory);
    ...
    @Test
    public void testGet_WithException_ReturnsNull() {
        // Arrange
        Integer categoryId = 1;
        when(categoryDao.get(categoryId)).thenThrow(new HibernateException("Test exception"));
    ...
    @Test
    public void testLoad_WithException_ReturnsNull() {
        // Arrange
        Integer categoryId = 1;
        when(categoryDao.load(categoryId)).thenThrow(new HibernateException("Test exception"));
    ...
    public void testDelete_WithException() {
        // Arrange
        doThrow(new HibernateException("Test exception")).when(categoryDao).delete(testCategory);
